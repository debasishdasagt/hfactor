...
<div class="row2" style="z-index:1" >
        <div class="container" style="max-width: 80%; padding-top: 50px">
        ...
        produce excellent outcomes for patients</p>  
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="doctile-sm" >
                            <div class="thumbnail">
                                <img class="img-circle img-thumbnail" src="../../master/doctor/picuploader/uploads/<?php 
                        ...
                        <div class="caption">
                            <div style="border-bottom: solid 1px #efefef; padding-bottom: 5px; margin-bottom: 3px; font-weight: bold"><?php echo $getdocr['d_name'] ?></div>
                            
                            <p style="font-size: 12px; color: #bbbbbb"><?php echo $getdocr['d_degree'] ?></p>
                            <a href="#" class="btn btn-info btn-xs" role="button">BOOK NOW</a>
                        </div></div>
            </div>
            <?php
                }}
