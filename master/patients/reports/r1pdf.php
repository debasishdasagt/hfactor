...
dc.chamber_id=ducm.chamber_id and ducm.user_id='$uid' and dc.record_status='A' and ducm.record_status='A';");
    ...
    <center>
        <h2>Doctor 24x7 (https://doctor247.in)</h2>
        <h3>Report: List Of Patients</h3>
        <h3>Report Generated by: Doctor</h3>
        <h3>From: <?php echo $fdate; ?> To: <?php echo $tdate; ?></h3>
    </center>
...
else if($rolecd=='1001')
{
    ...
    <center>
        <h2>Doctor 24x7 (https://doctor247.in)</h2>
        <h3>Report: List Of Patients</h3>
        <h3>Report Generated by: Admin</h3>
        <h3>From: <?php echo $fdate; ?> To: <?php echo $tdate; ?></h3>
    </center>
